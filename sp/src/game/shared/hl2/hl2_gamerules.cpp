...
CAmmoDef *GetAmmoDef()
{
	...
	if ( !bInitted )
	{
		...
		def.AddAmmoType("Nailgun",			DMG_BULLET,					TRACER_LINE,			"sk_plr_dmg_nailgun",		"sk_npc_dmg_nailgun",		"sk_max_nailgun",		BULLET_IMPULSE(200, 1225), 0);
		...
		def.AddAmmoType("NailGrenade",		DMG_BURN,					TRACER_NONE,			"sk_plr_dmg_grenade",		"sk_npc_dmg_grenade",		"sk_max_grenade",		0, 0); // TODO [WF] REPLACE THESE WITH SPECIFIC CONVARS!!!
